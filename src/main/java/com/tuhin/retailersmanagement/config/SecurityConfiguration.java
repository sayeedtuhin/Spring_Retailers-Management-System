 ...
 */
package com.tuhin.retailersmanagement.config;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/showingcategorypage").access("hasRole('ROLE_USER')")
                 .antMatchers("/showingCustomerinfo").access("hasRole('ROLE_USER')")
                 .antMatchers("/showingEmployeeinfo").access("hasRole('ROLE_USER')")
                 .antMatchers("/showingvendorinfo").access("hasRole('ROLE_USER')")
                 .antMatchers("/showPurchasepage").access("hasRole('ROLE_USER')")
                                 .antMatchers("/showattendpage").access("hasRole('ROLE_USER')")
