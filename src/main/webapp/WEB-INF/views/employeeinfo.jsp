                            ...
                            <form:form commandName="addEmployeeinfo1" action="addingemployee"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="emp Name" type="text" path="empname" required="true" id="empname"></form:input>
                                         ...
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Emp Address" type="text" path="empaddress" required="true" id="empaddress"></form:input>
                                            <label for="productname">Emp Address</label>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="customerphone" path="empnid" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Emp Nid</label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="empgender" path="empgender" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Gender</label>
                                        </div>
                                    </div>
                                            
                                         <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="empphone" path="empphone" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Phone</label>
                                        </div>
                                    </div>
                                            
                                            <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="empmail" path="empmail" required="true" id="productdescription"></form:input>
