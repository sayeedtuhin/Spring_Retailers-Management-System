            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Receive</li>
                    </ol>
                    <!-- end panel heading -->
                            ...
                            <form:form commandName="newreceiveObject" action="receiveadd"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Customer Name" value="{{sale.customerid}}" type="text" path="customerid" required="true" id="productname"></form:input>
                                ...
                                <form:hidden  class="form-control" value="{{sale.saleid}}" path="saleid"></form:hidden>
                                         ...
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Customer Name" value="{{sale.billtotal}}"  type="text" path="ammount" required="true" id="ammount"></form:input>
                                            <label for="ammount">Total-Ammount</label>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="Date" path="date" required="true" id="date"></form:input>
                                            <label for="productdescription">Date</label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="remarks" path="remarks" required="true" id="remarks"></form:input>
                                ...
                                <div class="form-group">
                                    ...
                                    <c:if test="${check}">
                                        <form:button id="editbuttons" type="submit" name="Add" class="btn btn-success">Confirm Payment</form:button>
                                        <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset Details</form:button>
                                    </c:if>
                                    <c:if test="${!check}">
                                        <form:button id="editbuttons" type="submit" name="Edit" class="btn btn-success">Edit Payment</form:button>
                                        <form:button id="removebuttons" type="reset" class="btn btn-danger">Reset Details</form:button>
                                    </c:if>
