            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- DataTables Example -->
                        <form:form method="POST" action="seview" commandName="reportInputForm">

            <table id="reptbl" width="350px" border="1">
               <div class="form-group ">
                            <label for="SaleId" class="control-label col-lg-3">SaleId :</label>
                            <div class="col-lg-6">
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-Sale</form:button>
