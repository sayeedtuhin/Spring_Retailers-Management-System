                            ...
                            <form:form commandName="newpaymentObject" action="payadd"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Vendor Id" type="text" path="vendorid" required="true" id="productname"  value="{{purchase.vendorid}}"></form:input>
                                         ...
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Customer Name" type="text" path="ammount" required="true" id="ammount"  value="{{purchase.billtotal}}"></form:input>
                                            <label for="productname">Total Ammount</label>
                                        </div>
                                    </div>   
                                            
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="paydate" type="text" path="paydate" required="true" id="date"></form:input>
                                            <label for="productname">Payment Date</label>
                                        </div>
                                    </div>   
