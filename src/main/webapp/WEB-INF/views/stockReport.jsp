    ...
    <body id="page-top" ng-app="organocartpackage" ng-controller="ProductController">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Stock-Repoprt</li>
                    </ol>
                    <!-- end panel heading -->
                    <div class="panel-body">
                        ...
                        <!-- DataTables Example -->
                        <form:form method="POST" action="stockview1" commandName="reportInputForm">
            ...
            <table id="reptbl" width="350px" border="1">
                ...
                <div class="col-lg-6">
                                    <select class="form-control" ng-model="prod" ng-options=" x.productname for x in products" required="true">
                                        <option value="">-- Product Type --</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                <form:hidden  class="form-control" value="{{prod.productname}}" path="pname"></form:hidden>
                                </div> 
                                
                                
                                
                                <div class="form-group ">
                            <label for="ptype" class="control-label col-lg-3">Product Type :</label>
                            <div class="col-lg-6">
                            <form:input class="form-control"
                                        Placeholder="" type="text"  value="{{prod.producttype}}" path="ptype" required="true"></form:input>
                            </div>
                        </div> 
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-Stock</form:button>
                        ...
                        <br>       
                        <div>
                    <form:form method="POST" action="stockview2" commandName="reportInputForm">
            ...
            <table id="reptbl" width="350px" border="1">
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-Total</form:button>
