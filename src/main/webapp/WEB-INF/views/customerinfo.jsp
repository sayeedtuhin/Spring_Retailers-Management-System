                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="addCustomerinfo1" action="addingcustomer"
                                       enctype="multipart/form-data">

                                <c:if test="${!check}">
                                    <div class="form-group">
                                        <form:input class="form-control" Placeholder="Customer Id"
                                                    type="text" path="customerid" readonly="true" required="true"></form:input>
                                        </div>
                                </c:if>
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Customer Name" type="text" path="customername" required="true" id="productname"></form:input>
                                         ...
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="Customer Name" type="text" path="customeraddress" required="true" id="productname"></form:input>
                                            <label for="productname">Customer Address</label>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="customerphone" path="customerphone" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Customer Phone</label>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="shopname" path="shopname" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Shop-Name</label>
                                        </div>
                                    </div>
