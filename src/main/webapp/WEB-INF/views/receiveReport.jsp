...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin - ReceivePayment</title>
...
<form:form method="POST" action="receiveview1" commandName="reportInputForm1">
            ...
            <table id="reptbl" width="350px" border="1">
                <div class="col-lg-6">
                                ...
                                <form:hidden  class="form-control" value="{{sale.saleid}}" path="sid"></form:hidden>
                                </div>  
                    
                <div class="col-lg-6">
                                <select class="form-control" ng-model="cust" ng-options=" x.customername for x in customerlist" required="true">
                                    <option value="">-- Cutomer Name --</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <form:hidden  class="form-control" value="{{cust.customername}}" path="cname"></form:hidden>
                                </div>
