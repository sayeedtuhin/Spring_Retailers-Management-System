...
//                        }
    ...
    <body  id="page-top" ng-app="organocartpackage" ng-controller="ProductController">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            ...
            <a class="navbar-brand mr-1" href="welcome">Retailers Management</a>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTables Example -->
                    <form:form method="POST" action="salaryView1" commandName="reportInputForm">

            <table id="reptbl" width="350px" border="1">
                
               <div class="col-lg-6">
                                <select class="form-control" ng-model="emp" ng-options=" x.empname for x in employeelist" required="true">
                                    <option value="">-- Emp_Name- --</option>
                                </select>
                                </div>
                                <div class="form-group">
                                <form:hidden  class="form-control" value="{{emp.empname}}" path="empname"></form:hidden>
                                
                                </div> 
                    
                <div class="form-group ">
                            <label for="empmail" class="control-label col-lg-3">Employee Email :</label>
                            <div class="col-lg-6">
                            <form:input class="form-control"
                                        Placeholder="" type="text"  value="{{emp.empmail}}"   path="empmail" required="true"></form:input>
                            </div>
                        </div> 
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-Salary</form:button>
                    ...
                    <br>
                    <div>
               <form:form method="POST" action="salaryView2" commandName="dddddd">

            <table id="reptbl" width="350px" border="1">
                <div class="form-group ">
                            <label for="startdate" class="control-label col-lg-3">StartDate :</label>
                            <div class="col-lg-6">
                            <form:input class="form-control"
                                        Placeholder="" type="text" path="sdate" required="true"></form:input>
                            </div>
                        </div>  
                    
                <div class="form-group ">
                            <label for="enddate" class="control-label col-lg-3">EndDate :</label>
                            <div class="col-lg-6">
                            <form:input class="form-control"
                                        Placeholder="" type="text" path="edate" required="true"></form:input>
                            </div>
                        </div> 
