                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="addVendorObject1" action="addingvendor"
                                       enctype="multipart/form-data">

                                <c:if test="${!check}">
                                    <div class="form-group">
                                        <form:input class="form-control" Placeholder="vendor Id"
                                                    type="text" path="vendorid" readonly="true" required="true"></form:input>
                                        </div>
                                </c:if>
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="vendor Name" type="text" path="vendorname" required="true" id="productname"></form:input>
                                            <label for="productname">Vendor Name</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        <form:input type="text" class="form-control" placeholder="vendoraddress" path="vendoraddress" required="true" id="productdescription"></form:input>
                                            <label for="productdescription">Vendoraddress</label>
                                        </div>
                                    </div>
