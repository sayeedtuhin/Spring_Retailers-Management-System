...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin - PurchaseDetails</title>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- DataTables Example -->
                        <form:form method="POST" action="purchaseview" commandName="reportInputForm">
                ...
                <div class="form-group ">
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-PurchaseDetails</form:button>
