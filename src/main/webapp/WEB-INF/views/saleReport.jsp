            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">SaleDetails-Repoprt</li>
                    </ol>
                    <!-- end panel heading -->
                    <div class="panel-body">
                        ...
                        <!-- DataTables Example -->
                        <form:form method="POST" action="saleview" commandName="reportInputForm">
            ...
            <table id="reptbl" width="350px" border="1">
                ...
                <div class="form-group ">
                            ...
                            <form:input class="form-control"
                                        Placeholder="" type="text" path="startdate" required="true"></form:input>
                            </div>
                        </div>  
                ...
                <div class="form-group ">
                            ...
                            <div class="col-lg-6">
                            <form:input class="form-control"
                                        Placeholder="" type="text" path="enddate" required="true"></form:input>
                            </div>
                        </div> 
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-SaleDetails</form:button>
