                        ...
                        <div class="formcontainer">
                                ...
                                <form:form name="addCategoryObject" modelAttribute="addCategoryObject1" action="addingcategory" method="post">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="product Id" type="text" path="productid"  id="productid"></form:input>
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input type="text" class="form-control" placeholder="producttype" path="producttype" required="true" id="producttype"></form:input>
                                                <label for="catdesc">Product Type</label>
                                        </div>
                                    </div>
                            ...
                            <c:if test="${!check}">
                                <form:form name="addCategoryObject" modelAttribute="addCategoryObject1" action="addingcategory" method="post">
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="product Id" type="text" path="productid" required="true" id="productid"></form:input>
