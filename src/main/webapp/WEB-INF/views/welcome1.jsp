...
<html lang="en">
    ...
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="resources/plugin2/css/bootstrap.min.css" rel="stylesheet">
        <!-- Material Design Bootstrap -->
        <link href="resources/plugin2/css/mdb.min.css" rel="stylesheet">
        <!-- Your custom styles (optional) -->
        <link href="resources/plugin2/css/style.min.css" rel="stylesheet">
    ...
    <body class="grey lighten-3">
        ...
        <header>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <a class="nav-link waves-effect" href="/retailersManagement">Home
                        ...
                        <ul class="navbar-nav nav-flex-icons">
                            ...
                            <li class="nav-item">
                                <a href="logout"> <button type="button" class="btn btn-primary btn-sm" 
                                                          >Logout </button></a>
                            </li>
                        </ul>
            ...
            <div class="sidebar-fixed position-fixed">
                ...
                <a class="logo-wrapper waves-effect">
                    <img src="resources/plugin2/img/3d.png" class="img-fluid" alt="img">
                </a>

                <div class="list-group list-group-flush" >
                    <a href="#" class="list-group-item active waves-effect">
                        <i class="fa fa-pie-chart mr-3"></i>Admin Acitvity
                    </a>
                    
                    <div class="btn-group dropright">
                        <button type="button" class="btn btn-primary">Vendor Section</button>
                        <button type="button" class="btn btn-primary dropdown-toggle px-3" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="showingvendorinfo">Vendor-Info</a>
                            <a class="dropdown-item" href="showingcategorypage">Add-product</a>
                            <a class="dropdown-item" href="showcartpage">Purchase</a>
                             <a class="dropdown-item" href="showdetail">Detail List</a>
                             <a class="dropdown-item" href="showvendorpaytpage">Payment</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="viewShowpurchase">Separated link</a>
                        </div>
                    </div>
                    
                    
                    <a href="showstock" class="list-group-item list-group-item-action waves-effect">
                        <i class="fa fa-map mr-3"></i>Stock</a>
                    

                    <div class="btn-group dropright">
                        <button type="button" class="btn btn-primary">Client-Section</button>
                        <button type="button" class="btn btn-primary dropdown-toggle px-3" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="showingCustomerinfo">Customer-Info</a>
                            <a class="dropdown-item" href="showcartpage1">Sale</a>
                              <a class="dropdown-item" href="showsaledetail"> Sale Detail List</a>
                    ...
                    <a href="#" class="list-group-item list-group-item-action waves-effect">
                        <i class="fa fa-money mr-3"></i>Report</a>

                    <div class="btn-group dropright">
                        <button type="button" class="btn btn-primary">Emp Section</button>
                        <button type="button" class="btn btn-primary dropdown-toggle px-3" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            <span class="sr-only">Toggle Dropdown</span>
                        </button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="showingEmployeeinfo">Emp-Info</a>
                            <a class="dropdown-item" href="showattendpage">Emp-Attendance</a>
                            <a class="dropdown-item" href="showsalarytpage">Emp-Salary</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">Separated link</a>
                        </div>
                    </div>
        ...
        <!-- SCRIPTS -->
        <!-- JQuery -->
        <script type="text/javascript" src="resources/plugin2/js/jquery-3.3.1.min.js"></script>
        <!-- Bootstrap tooltips -->
        <script type="text/javascript" src="resources/plugin2/js/popper.min.js"></script>
        <!-- Bootstrap core JavaScript -->
        <script type="text/javascript" src="resources/plugin2/js/bootstrap.min.js"></script>
        <!-- MDB core JavaScript -->
        <script type="text/javascript" src="resources/plugin2/js/mdb.min.js"></script>
        <!-- Initializations -->
