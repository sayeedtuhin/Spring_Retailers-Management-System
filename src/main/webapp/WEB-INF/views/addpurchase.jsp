    ...
    <body id="page-top" ng-app="organocartpackage" ng-controller="ProductController">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="newpurchaseObject" action="addtocart"
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="quantity Name" type="text" path="quantity" required="true" id="productname"></form:input>
                                            <label for="productname">Quantity Name</label>
                                        </div>
                                    </div>
                                            
                                         <div class="form-group">
                                    <div class="form-label-group">
                                        <form:input class="form-control" Placeholder="price" type="number" path="price" required="true" id="productname"></form:input>
                ...
                <h3 style="text-align: center; color: #00acc1"
                        ...
                        <form:form commandName="newpurchaseObject" action="addpurchasepage"
                            ...
                            <div class="form-group">
                                <form:hidden  class="form-control" value="{{vendorid}}" path="vendorid"></form:hidden>
                                 ...
                                 <div class="form-group">
                                <form:input type="number" class="form-control"  path="billtotal" placeholder="Total-bill" required="true" value="${sessionScope.grandtotal}" readonly="true" ></form:input>
                                </div>
