...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin - VendorPayment</title>
        ...
        <div id="wrapper">
            ...
            <table id="reptbl" width="350px" border="1">
                <div class="col-lg-6">
                                ...
                                <form:hidden  class="form-control" value="{{purchase.purchaseid}}" path="pid"></form:hidden>
                                </div>    
                    
                <div class="col-lg-6">
                                <select class="form-control" ng-model="vend" ng-options="x.vendorname for x in vendorlist" required="true">
                                    <option value="">-- Vendor Name --</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <form:hidden  class="form-control" value="{{vend.vendorname}}" path="vname"></form:hidden>
                                </div>
                 ...
                 <div class="col-lg-offset-3 col-lg-6">
                        <form:button  type="submit" 
                                     class="btn btn-info">Search-VendorPayment</form:button>
